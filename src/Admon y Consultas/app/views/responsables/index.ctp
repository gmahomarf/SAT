...
<h2><?php __('Administraci&oacute;n de Responsables');?></h2>
<p>
<?php
...
?>
	<tr<?php echo $class;?>>
        ...
        <td class="actions">
			...
			<?php echo $html->link(__('Editar', true), array('action' => 'editar', $responsable['Responsable']['id'])); ?>
...
<div class="actions">
	<ul>
		<li><?php echo $html->link(__('Nuevo responsable', true), array('action' => 'agregar')); ?></li>
