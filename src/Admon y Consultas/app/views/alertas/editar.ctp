<?php
    ...
    \n
    var frmVal = new Form.Validator.Inline('AlertaEditarForm', {\n
    ...
    echo $html->tag('h1', 'Editar Alerta');
    echo $html->tag('fieldset');
    echo $html->tag('legend', 'Editar Alerta');
    echo $form->create('Alerta', array('action' => 'editar'));
